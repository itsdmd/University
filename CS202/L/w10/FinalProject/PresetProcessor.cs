...
namespace FinalProject
{
    public static class PresetProcessor
    {
		...
		public static List<IRule> ReadPresetFile(String target, RuleFactory ruleFactory, out bool success)
		{
			success = false;
		...
		internal static void ReadPresetFile(OpenFileDialog dialog, RuleFactory f)
		{
