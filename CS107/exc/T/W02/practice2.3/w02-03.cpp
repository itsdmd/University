// Student information: name, literature and math points. Construct class Student with the following methods:
...
// - calculateGPA: return GPA of student. (GPA= (literature + math ) / 2)
