...
int ArrayLastEvenVal(ARRAY, int);
...
int main()
{
    ...
    if (ArrayLastEvenVal(arr, size) == -1)
        cout << "Mang khong co so chan";
    
    else
        cout << "Gia tri chan cuoi cung cua mang la: " << ArrayLastEvenVal(arr, size);
...
///                             ArrayLastEvenVal()                           ///
/// ------------------------------------------------------------------------ ///
int ArrayLastEvenVal(ARRAY inp, int size)
{
    int res = -1;
