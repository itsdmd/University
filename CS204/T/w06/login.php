    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 pl-5">
                ...
                <h2><i class="fa fa-plus-circle" aria-hidden="true"></i> Login
                </h2>
                <form action="login.php" method="post">
                    <div class="form-group">
                        <label for="my-input">Choose a username</label>
                    ...
                    <button type="submit" class="btn btn-primary btn-block btn-lg" name="login"><i class="fa fa-plus-circle" aria-hidden="true"></i>
                        Login</button>
