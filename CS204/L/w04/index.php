...
<div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
  <div class="col-md-6 px-0">
    ...
    <p class="lead my-3">Multiple lines of text that form the
      lede, informing new readers quickly and efficiently
    ...
    <div class="col-md-6">
      <div class="card flex-md-row mb-4 box-shadow h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          <strong class="d-inline-block mb-2 text-primary"><?php echo $post["user_nicename"] ?></strong>
          <h3 class="mb-0">
            <a class="text-dark" href="#"><?php echo $post["post_title"] ?></a>
          </h3>
          <div class="mb-1 text-muted"><?php echo $post["post_date"] ?>
          </div>
          <p class="card-text mb-auto"><?php echo $post["post_content"] ?>
          </p>
          <a href="post.php?id=<?php echo $post["ID"] ?>">Continue
            reading</a>
        </div>
    ...
    <div class="col-md-8 blog-main">
      ...
      <div class="blog-post">
        ...
        <p>Vivamus sagittis lacus vel augue laoreet rutrum
          ...
          odio sem nec elit. Morbi leo risus, porta ac
        ...
        <p>Aenean lacinia bibendum nulla sed consectetur. Etiam
          porta sem malesuada magna mollis euismod. Fusce
          dapibus, tellus ac cursus commodo, tortor mauris
          condimentum nibh, ut fermentum massa.</p>
        <h3>Sub-heading</h3>
        <p>Cum sociis natoque penatibus et magnis dis parturient
          montes, nascetur ridiculus mus. Aenean lacinia
          bibendum nulla sed consectetur. Etiam porta sem
          malesuada magna mollis euismod. Fusce dapibus,
          tellus ac cursus commodo, tortor mauris condimentum
          nibh, ut fermentum massa justo sit amet risus.</p>
        <ul>
          <li>Praesent commodo cursus magna, vel scelerisque
            nisl consectetur et.</li>
