            ...
            <div id="my-nav" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="<?= ROOT ?>"><i class="fas fa-home"></i>
                            Home<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="create"><i class="fas fa-plus"></i> Add University</a>
                    </li>
                    <?php if (isset($_SESSION['username'])) : ?>
                        <!-- <li class="nav-item ">
                        <a class="nav-link" href="user"><i
                                class="fas fa-user"></i> Welcome User</a>
                    </li> -->
                        <li class="nav-item ">
